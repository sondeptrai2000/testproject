...
adminRouter.get('/getStudentProgress', adminController.getStudentProgress);
adminRouter.get('/getTeacherProfile', adminController.getTeacherProfile);
adminRouter.get('/myAttended', adminController.myAttended);
